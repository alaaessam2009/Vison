     ...
     <div class="container">
        ...
        <nav>
           <ul>
              ...
              <li>  <a href="whichsign.html"> Sign up</a>   </li>
          </ul>
     </nav>
   </div>
 ...
 <div class="parent-div">
    ...
    <div class="message-div">
     ...
     <form action="sendMessage">            
         <input class="message_input" type="text" placeholder="Name"  required autocomplete="off" name="name" >                     
       <input class="message_input" type="text" placeholder="Email" required autocomplete="off" name="email" > 
       <textarea class="message_input" placeholder="Message" rows="8" cols="38" required name="message"></textarea>   
